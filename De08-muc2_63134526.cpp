...
// Ham tim node c� gia tri nho nhat trong cay con ben trai cua mot node cho truoc 
...
int main() {
    ...
    ifstream inputFile("input.txt"); // �?i "ten_file.txt" th�nh t�n th?c t? c?a file
    ...
    if (inputFile.is_open()) {
        ...
        return 1; // Tho�t ch��ng tr?nh n?u kh�ng th? m? file
    }
